...
ACTIVE_POOL = [
    ...
    # "x-ai/grok-3-mini-beta",          # DEAD — 404 on OpenRouter as of 2026-06-07
    # "nvidia/llama-3.1-nemotron-70b-instruct",  # DEAD — 404 on OpenRouter as of 2026-06-07
]
...
_MODEL_REGISTRY = {
    ...
    # "x-ai/grok-3-mini-beta": DEAD — removed 2026-06-07 (404 on OpenRouter)
    # "nvidia/llama-3.1-nemotron-70b-instruct": DEAD — removed 2026-06-07 (404 on OpenRouter)
    # RETIRED
...
CASCADE_ORDER = {
    "coding":        ["openai/gpt-4o-mini", "mistralai/mistral-small-3.2-24b-instruct", "microsoft/phi-4", "qwen/qwen3-235b-a22b", "anthropic/claude-haiku-4.5", "openai/o3-mini"],
